...
<title>Nueva contraseña — SaaS Tienda Moda</title>
...
<body>
    <div class="card">
        ...
        <p class="sub">Define una nueva contraseña para tu cuenta.</p>

        @if(session('error'))
            <div class="alert alert-err"><i class="fa-solid fa-circle-exclamation"></i> {{ session('error') }}</div>
        @endif
        ...
        <form method="POST" action="{{ route('password.update') }}">
            ...
            <button type="submit" class="btn"><i class="fa-solid fa-check" style="margin-right:8px;"></i>Restablecer contraseña</button>
        </form>
